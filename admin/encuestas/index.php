...
<head>
<title><?php echo NAME; ?> | Màs pedidos</title>
<meta charset="utf-8">
...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Encuestas</h4></div>
...
<select name="tienda" id="tienda" onchange="Buscar()" class="custom-select">
...
foreach($rows as $row){
  $i++;   
        ...
        echo '<option value="'.$row['PK'].'">'.utf8_encode($row['NOMBRE']).'</option>';
...
<div class="table-responsive">
            <table class="table table-striped table-sm">
              <thead class="thead-dark">
                <tr>
                  <th>#</th>
                  <th>¿Fuiste atendido correctamente por el repartidor?</th>
                  <th>¿La calidad de los productos es buena?</th>
                  <th>¿Los Costos de los productos son buenos?</th>
                  <th>¿Volverías a ocupar la aplicación?</th>
                  <th>¿Cada cuanto la ocuparías?</th>
                  <th>Observación o Recomendaciones.</th>
                  <th>Cliente</th>
                  <th>Total</th>
                </tr>
...
<script src="../assets/js/pages/encuestas.js"></script>
