...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Tiendas Departamentos</h4></div>
</div>

<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
<li class="breadcrumb-item"><a href="#">Agregar Nuevo Departamento</a></li>
</ol>
</div>
...
<form class="needs-validation" id="formasociados" validate>
      ...
      <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
          ...
          <button class="btn btn-primary btn-lg btn-block" type="submit">Guardar Departamento</button>
        ...
        <div class="col-md-8 order-md-1">
          ...
          <div class="row">
              ...
              <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control" id="categoria" name="categoria" placeholder="Nombre del Departamento" value="" required>
              </div>
            </div>
...
<script src="../../assets/js/pages/asociados-categorias-agregar.js"></script>
