...
<head>
<title><?php echo NAME." | Departamentos"; ?></title>
<meta charset="utf-8">
...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Departamentos Tiendas</h4></div>
<div class=""><a href="add.php" class="btn btn-primary btn-glow-primary"><span class="ion ion-md-add"></span>&nbsp; Agregar Departamento</a></div>
</div>
...
<select name="categorias" id="categorias" onchange="Buscar()" class="custom-select">
...
<script src="../../assets/js/pages/categorias-asociados.js"></script>
