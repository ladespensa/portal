...
if($row){
  ...
  $asociado = utf8_encode($row['NOMBRE']);
}
...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0"><?php echo $asociado;  ?> - Productos</h4></div>
<div class=""><a href="add.php?id=<?php echo $id; ?>" class="btn btn-primary btn-glow-primary"><span class="ion ion-md-add"></span>&nbsp; Agregar Producto</a></div>
</div>
...
<div class="col-md my-2">
<label class="form-label pb-1">Categorías</label>

<select name="categorias" class="form-control" id="categorias" onchange="Buscar()">
              <?php
