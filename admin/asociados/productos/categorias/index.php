...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Categorías Productos</h4></div>
<div class=""><a href="add.php" class="btn btn-primary btn-glow-primary"><span class="ion ion-md-add"></span>&nbsp; Agregar Categoria</a></div>
</div>
...
<script src="../../../assets/js/pages/categorias-productos.js"></script>
