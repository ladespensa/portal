...
$id = $_GET['id'];
$sql = 'SELECT * FROM CATEGORIAS where PK='.$id;
...
$row = database::getRow($sql);
    ...
    if($row){
          ...
          $grupo = $row['PK_GRUPO'];
          $tipo_tienda = $row['PK_TIPO_TIENDA'];
      }
...
<li class="breadcrumb-item"><a href="#">Editar Categoría</a></li>
</ol>
</div>
...
<div class="row">
  <div class="col-md-4 order-md-2 mb-4">
    ...
    <button class="btn btn-primary btn-lg btn-block" type="submit">Actualizar Categoría</button>
  ...
  <div class="col-md-8 order-md-1">
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
          ...
          <input type="text" class="form-control" id="categoria" name="categoria" placeholder="Nombre de la categoria" value="<?php echo utf8_encode($tipo); ?>" required>
        </div>
      </div>
          ...
          <select class="form-control" name="tipo" id="tipo">
                   <?php
                      ...
                      foreach($rows as $row){
                           ...
                           if($row['PK']==$tipo_tienda){ $selected="selected"; }else{ $selected=""; }

                            echo '<option value="'.$row['PK'].'"  '.$selected.'>'.utf8_encode($row['TIPO']).'</option>';
                      }
          ...
          <select class="form-control" name="grupo" id="grupo">
                   <?php
                      ...
                      foreach($rows as $row){
                           ...
                           if($row['PK']==$grupo){ $selected="selected"; }else{ $selected=""; }

                            echo '<option value="'.$row['PK'].'"  '.$selected.'>'.utf8_encode($row['GRUPO']).'</option>';
                      }
      ...
      <div class="row">
        <div class="col-md-12 mb-3">
          ...
          <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="" value="<?php echo utf8_encode($descripcion); ?>" >
        </div>
      </div>
...
<script src="../../../assets/js/pages/productos-categorias-editar.js"></script>
