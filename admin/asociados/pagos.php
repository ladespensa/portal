...
<head>
<title><?php echo NAME.' | Pagos'; ?></title>
<meta charset="utf-8">
...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Realizar Pagos Tienda</h4></div>
...
<select name="tienda" id="tienda" class="form-control" onchange="CambiarTienda(this.value)">
              <?php
                      ...
                      foreach($rows as $row){
                            ...
                            echo '<option value="'.$row['PK'].'" '.$select.' >'.utf8_encode($row['NOMBRE']).'</option>';
                      }
...
<script src="../assets/js/pages/asociados-pagos.js"></script>
