...
<head>
<title>Polar | Monitoreo de Pedidos</title>
<meta charset="utf-8">
    ...
    <h4 class="mb-3">Información General</h4>
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="nombre" name="grupo" placeholder="Grupo" value="" required>
          </div>

          <div class="col-md-6 mb-3">
            <label for="apellidos">Descripción</label>
            <input type="text" class="form-control" id="apellidos" name="descripcion" placeholder="Descripción" value="" required>
          </div>
