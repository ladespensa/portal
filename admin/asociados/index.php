...
<head>
<title><?php echo 'AC MARKET | Asociados'; ?></title>
<meta charset="utf-8">
...
<div class=""><a href="add.php" class="btn btn-primary btn-glow-primary"><span class="ion ion-md-add"></span>&nbsp; Agregar Tienda</a></div>
</div>
...
<script src="../assets/js/pages/asociados.js"></script>
