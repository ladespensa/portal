...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Productos más vendidos</h4></div>
...
<li class="breadcrumb-item"><a href="#">Màs pedidos </a></li>
</ol>
</div>
...
<script src="../assets/js/pages/mas_pedidos.js"></script>
