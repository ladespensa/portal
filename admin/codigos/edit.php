...
$id = $_GET['id'];
$sql = 'SELECT * FROM CODIGOS_DESCUENTO where PK='.$id;
...
$row = database::getRow($sql);
    ...
    if($row){
          ...
          $codigo = $row['CODIGO'];
          $descuento = $row['POCENTAJE_DESCUENTO'];
          $usos = $row['MAXIMO_USOS'];
          $inicio = $row['FECHA_INICIO']->format('d/m/Y');
          $termino = $row['FECHA_TERMINO']->format('d/m/Y');
        ...
        <div class="col-md-8 order-md-1">
          ...
          <div class="row">
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control" id="folio" name="folio" placeholder="" value="<?php echo $codigo; ?>" required>
              </div>

              <div class="col-md-3 mb-3">
                <label for="descuento">Descuento (%)</label>
                <input type="number" class="form-control" min="1" max="100" step="0.01" id="descuento" name="descuento" placeholder="" value="<?php echo $descuento; ?>" required>
              </div>


              <div class="col-md-3 mb-3">
                <label for="usos">Máximo Uso</label>
                <input type="number" class="form-control" min="1" max="3000" step="1" id="usos" name="usos" placeholder="" value="<?php echo $usos; ?>" required>
              </div>
            ...
            <div class="row">
              ...
              <div class="input-group date">
                <input type="text" class="form-control" style="width:110px;" name="date" id="date" value="<?php echo $inicio; ?>" required><span class="input-group-addon">
              ...
              <div class="input-group date">
                <input type="text" class="form-control" style="width:110px;" name="date2" id="date2" value="<?php echo $termino; ?>" required><span class="input-group-addon">
                <i class="fa fa-calendar" style="font-size:36px"></i>
                </span>
              </div>
              </div>
...
<script src="../assets/js/pages/codigos-editar.js"></script>
