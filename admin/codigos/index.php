...
<head>
<title><?php echo NAME.' | Códigos de descuento'; ?></title>
<meta charset="utf-8">
...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Codigos Descuentos</h4></div>
...
<div class=""><a href="add.php" class="btn btn-primary btn-glow-primary"><span class="ion ion-md-add"></span>&nbsp; Crear</a></div>
</div>
...
<script src="../assets/js/pages/codigos.js"></script>
