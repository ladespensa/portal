...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Tendedero</h4></div>
</div>
      ...
      <div class="row">
        ...
        <div class="col-md-3 mb-3">
          ...
          <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" id="municipio" name="municipio" placeholder="" value="" required>
          </div>
        ...
        <div class="col-md-9 mb-3">
            ...
            <input type="text" class="form-control" id="calle" name="calle" placeholder="" value="" required>
          </div>
...
<div class="row">
        ...
        <label for="zip">Clabe</label>
          <input type="text" class="form-control" name="clabe" id="clabe" placeholder="" value="" required>
         
        </div>
        
        <div class="col-md-3 mb-3">
          <label for="zip">Cuenta</label>
          <input type="text" class="form-control" name="cuenta" id="cuenta" placeholder="" value="" required>
      ...
      <hr class="mb-4">
      <button class="btn btn-primary btn-lg btn-block" type="submit">Guardar Tendero</button>
    </form>
        </div>
...
<script src="../assets/js/pages/tendederos-agregar.js"></script>
