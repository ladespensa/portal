...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Repartidores</h4></div>
<?php
if($_SESSION['POLARSESSION']['PK_ROL']==1){
  ?>
<div class=""><a href="add.php" class="btn btn-primary btn-glow-primary"><span class="ion ion-md-add"></span>&nbsp; Agregar</a></div>
<?php }?>
</div>
...
<li class="breadcrumb-item"><a href="#">Lista <span class="badge badge-danger">3</span></a></li>
</ol>
</div>
...
<script src="../assets/js/pages/tendederos.js"></script>
