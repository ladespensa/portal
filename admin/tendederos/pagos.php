...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Realizar Pagos Repartidores</h4></div>
...
<div class=""><button class="btn btn-primary btn-glow-primary" onclick="Liquidar()"><span class="ion ion-md-card"></span>&nbsp;Liquidar</button></div>
...
<select name="repartidor" id="repartidor" class="form-control" onchange="CambiarTienda(this.value)">
              <?php
                      ...
                      foreach($rows as $row){
                                 if($_GET['id']==$row['PK']){ $select = "selected"; }else{ $select = ""; }

                            echo '<option value="'.$row['PK'].'" '.$select.' >'.utf8_encode($row['NOMBRE'].' '.$row['APATERNO'].' '.$row['AMATERNO']).'</option>';
                      }
...
<div class="table-responsive">
              ...
              <thead class="thead-dark">
                <tr>
                  ...
                  <th>Total</th>
                  <th>Metodo Pago</th>
                  <th>Deposito Repart.</th>
                  <th>Comisión Repart.</th>
                  <th>Pago Comisión Repart..</th>
                  <th>Fecha Pago.</th>
                </tr>
              </thead>
...
<script src="../assets/js/pages/tendederos-pagos.js"></script>
