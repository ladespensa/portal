...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Reportes - Tiendas</h4></div>
...
<li class="breadcrumb-item"><a href="#">Lista Tiendas</a></li>
</ol>
</div>
...
<select name="tienda" id="tienda" class="form-control" onchange="Buscar()">
              <?php
                      ...
                      foreach($rows as $row){
                            ...
                            echo '<option value="'.$row['PK'].'" '.$select.' >'.$row['NOMBRE'].'</option>';
                      }
...
<script src="../assets/js/pages/comprobantes-tiendas.js"></script>
