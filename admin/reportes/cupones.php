...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Reporte Cupones</h4></div>
...
<div class="input-group date">
                <input type="text" class="form-control" style="width:110px;" id="date-inicio"><span class="input-group-addon">
...
<script src="../assets/js/pages/reportes-cupones.js"></script>
