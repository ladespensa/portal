...
<div class="d-flex">
<div class=" flex-grow-1"><h4 class="font-weight-bold py-3 mb-0">Reportes - Repartidores</h4></div>
...
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i>Comprobantes</a></li>
<li class="breadcrumb-item"><a href="#">Lista Repartidores</a></li>
</ol>
</div>
...
<select name="repartidor" id="repartidor" class="form-control" onchange="Buscar()">
              <?php
...
<div class="table-responsive">
            ...
            <h5 class="mb-3">Acumulado de Pago</h5>
                        <hr class="mb-4">
...
<script src="../assets/js/pages/comprobantes-repartidores.js"></script>
