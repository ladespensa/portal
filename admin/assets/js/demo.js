...
'<h5 class="m-0">Administración Accesos Rápidos</h5>'+
'</div>'+
...
'<span class="switcher-label"><a href=""><b>Tiendas</b></a></span>'+
'</label><br>'+
''+
''+
'<span class="switcher-label"><a href=""><b>Repartidores</b></a></span>'+
'</label><br>'+
'<label class="switcher switcher-dark mb-4 w-100 text-right">'+
'<input type="checkbox" class="switcher-input" id="head-dark" checked>'+
'<span class="switcher-label"><a href=""><b>Pedidos</b></a></span>'+
'</label><br>'+
'<h6 class="mb-2">Reportes</h6>'+
'<label class="switcher switcher-dark mb-0 w-100 text-right">'+
'<span class="switcher-label"><b>Comprobantes Tiendas</b></span>'+
'</label><br>'+
'<label class="switcher switcher-dark mb-0 w-100 text-right">'+
''+
'<span class="switcher-label"><b>Comprobantes Repartidores</b></span>'+
'</label><br>'+
'</div>'+
'</div>'+
'</div>'+
